...
L["Show a popup window when you join a Mythic+ group."] = "Показывать всплывающее окно при вступлении в группу Mythic+."
...
L["Joined Mythic+ Group"] = "Вступил в группу Mythic+"
...
L["Mythic Plus Key Group:"] = "Группа с ключом Mythic Plus:"
L["No recent group found."] = "Недавняя группа не найдена."
L["Re-sent last announcement."] = "Повторно отправлено последнее оповещение."
L["No plain announcement available to resend."] = "Нет доступного простого оповещения для повторной отправки."
